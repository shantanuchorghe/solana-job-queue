...
exports.deriveIndexPda = deriveIndexPda;
...
function deriveQueuePda(programId, authority, queueName) {
    return web3_js_1.PublicKey.findProgramAddressSync([new TextEncoder().encode("queue"), authority.toBytes(), new TextEncoder().encode(queueName)], programId);
}
